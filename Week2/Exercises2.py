...
def average(numlis):
    ...
    for items in numlis:
        add += items
      #  print(items) - # Use this if you want to get the items if you don't use it you will only get the average.
    average = add / len(numlis)
...
#%%
def report(lis):
    for state, population in lis:
        print(f"State is {state} and populations is {population}.")
